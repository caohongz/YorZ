...
import { Group, Segmented } from '@/components/SettingsControls.jsx'
...
type AgentKindOption = 'inherit' | 'claude' | 'codex' | 'opencode' | 'pi' | 'mimo'
...
export const ProjectSettings: Component = () => {
  ...
  const onKindChange = (kind: AgentKindOption) => void save({ kind })
