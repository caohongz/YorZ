export const zhCN = {
  ...
  addProject: {
    ...
    title: '添加项目',
    help: '帮助',
    helpTooltip: '也可使用命令 `yorz add <path>` 添加项目',
    parent: '上级目录',
    home: '主目录',
    driveRoot: '此电脑',
    empty: '该目录下没有子目录',
    truncated: '子目录过多，仅显示前 1000 项',
    showHidden: '显示隐藏目录',
    choose: '选择此目录',
    loading: '加载中…',
    newFolder: '新建文件夹',
    ...
    newFolderConfirm: '创建',
    invalidName: '名称不能为空，且不能包含路径分隔符',
    gitInitTitle: '该目录不是 git 仓库',
    gitInitDesc: '{{path}} 尚未 git init。YorZ 的 git 面板与 worktree 功能依赖 git 仓库。',
    gitInitConfirm: '执行 git init 并添加',
    failed: '添加失败：{{message}}',
  },
  sidebar: {
    title: '项目',
